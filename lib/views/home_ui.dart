// ignore_for_file: must_be_immutable, prefer_const_constructors, prefer_const_literals_to_create_immutables, sized_box_for_whitespace, avoid_print
...
import 'package:money_tracking/models/money.dart';
import 'package:money_tracking/models/user.dart';
import 'package:money_tracking/services/call_api.dart';
import 'package:money_tracking/views/supviews/add_expense_screen_ui.dart';
import 'package:money_tracking/views/supviews/add_income_screen_ui.dart';
import 'package:money_tracking/views/supviews/record_ui.dart';
          ...
          Align(
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                color: const Color.fromARGB(255, 253, 106, 155),
                child: Center(
                  child: _isLoading
